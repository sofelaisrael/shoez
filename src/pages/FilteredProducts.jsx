      ...
      <div className="grid grid-cols-7 max-lg:flex  max-lg:flex-col-reverse pb-10 ">
        <div className="filters max-md:px-5 px-10 col-span-2 max-lg:h-full flex flex-col justify- py-10 gap-2 items-center ">
          ...
          <div className="btns flex gap-5 max-lg:gap-2 my-5 w-full max-md:flex-col ">
            <button
              className="flex max-md:w-full gap-2 border bg-black rounded-md text-white items-center justify-center p-3 w-32"
              onClick={() => {
                setCurrentPage(1);
        ...
        {currentItems.length > 0 ? (
          <div
            id="data-container"
            className="grid grid-cols-4  gap-10 p-10 max-md:p-5 max-md:gap-5 col-span-5 max-lg:col-span-full relative max-lg:grid-cols-3 max-md:grid-cols-2"
          >
          ...
          <div className="none border w-full col-span-5 flex justify-center items-center font-bold text-[32px] flex-col gap-3">
            ...
            <button
              ...
              className="flex font-normal max-md:w-full gap-2 w-[150px] border bg-black rounded-md text-white items-center justify-center h-[50px] "
            >
              Reset
            </button>
          </div>
