...
import { addToWishList, clearList, removeitem } from "../features/wishListSlice";
    ...
    return (
        <div className='h-[100vh] pt-20'>
            ...
            {list.length > 0 ? (
                ...
                <div className="none mx-auto w-[80%]  max-lg:w-[90%] relative text-center text-[32px] font-bold h-[200px] flex items-center justify-center">No items avaiable in your wish list</div>
            )}
            ...
            <div className="btns flex items-center justify-between max-lg:gap-3 w-[80%] max-lg:w-[90%] max-lg:flex-col mx-auto py-10">
                ...
                <div className="cart flex items-center gap-5  max-lg:gap-8 max-lg:flex-col-reverse max-lg:w-full ">
                    <div className="clear p-5 max-lg:p-0  max-lg:flex justify-center items-center cursor-pointer hover:text-white max-lg:h-[50px] font-bold bg-transparen rounded-md hover:bg-[#232324] text-center transition-all duration-300 border max-lg:text-[14px] max-lg:w-full" onClick={() => dispatch(clearList())}>
                        Clear List
                    </div>
